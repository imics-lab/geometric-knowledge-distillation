...
from src.mhad_data import get_distillation_dataloader_from_folder
...
dtw_distances = np.load('../results/skeleton/distances_train_all.npy')
folder_path = '../data/Skeleton_numpy'
